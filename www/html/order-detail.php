...
<head>
    ...
    <!-- Title  -->
    <title>Amado - Furniture Ecommerce Template | Ordered Products</title>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="cart-table clearfix">
                        <table class="table table-responsive">
                            ...
                            <tbody>
                            <?php foreach ($orderDetail as $key => $orderProduct): ?>
                                <tr>
                                    <td class="sales_id">
                                        <h5><?php echo $orderProduct['order_id']; ?></h5>
                                    </td>
                                    <td class="product_name">
                                        <h5><?php echo $orderProduct['product_name']; ?></h5>
                                    </td>
                                    <td class="quantity">
                                        <span><?php echo $orderProduct['quantity']; ?></span>
                                    </td>
                                    <td class="price">
                                        <span>$<?php echo $orderProduct['price']; ?></span>
                                    </td>
                                    <td class="subtotal">
                                        <span>$<?php echo ($orderProduct['quantity']*$orderProduct['price']); ?></span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
