...
<head>
    ...
    <!-- Title  -->
    <title>Amado - Furniture Ecommerce Template | Edit Product</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <!--                                <td></td>-->
                    <!--                                <td class="cart_product_desc">-->
                    <!--                                    <input type='text' name='GoodsName' size="25" required>-->
                    <!--                                </td>-->
                    <!--                                <td class="price">-->
                    <!--                                    <input type='text' name='Price' size="10" required>-->
                    <!--                                </td>-->
                    <!--                                <td class="qty">-->
                    <!--                                    <input type='text' name='Quantity' size="10" required>-->
                    <!--                                </td>-->
                    <!---->
                    <!--                            </tr>-->
                    <!--                            </form>-->
                    ...
                    <div>
                        <form action="" method="post">
                            ...
                            <div>
                                <input class="btn amado-btn active" type='submit' name='submitUpdate'
                                       value=' Edit Product '>
                            </div>
                        </form>
