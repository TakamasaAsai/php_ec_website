...
<head>
    ...
    <!-- Title  -->
    <title>Amado - Furniture Ecommerce Template | Order History</title>
                            ...
                            <?php foreach ($orderHistory as $key => $order): ?>
                                <tr>
                                    <td class="cart_product_img">
                                        <h5><?php echo $order['user_name']; ?></h5>
                                    </td>
                                    ...
                                    <td class="qty">
                                        <div class="qty-btn d-flex">
                                            <div class="quantity">
                                                <form action="order-detail.php" method="post" name="update_quantity">
                                                    <input type="hidden" name="order_id" value="<?php echo $order['id']; ?>">
                                                    <button type="submit" class="btn btn-red quantity">Detail Page</button>
                                                </form>
